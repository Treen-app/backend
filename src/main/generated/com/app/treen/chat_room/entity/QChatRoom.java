...
public class QChatRoom extends EntityPathBase<ChatRoom> {
    ...
    public final com.app.treen.auth.entity.QUser buyer;
    ...
    public final com.app.treen.auth.entity.QUser seller;
    ...
    public QChatRoom(Class<? extends ChatRoom> type, PathMetadata metadata, PathInits inits) {
        ...
        this.buyer = inits.isInitialized("buyer") ? new com.app.treen.auth.entity.QUser(forProperty("buyer")) : null;
        this.seller = inits.isInitialized("seller") ? new com.app.treen.auth.entity.QUser(forProperty("seller")) : null;
